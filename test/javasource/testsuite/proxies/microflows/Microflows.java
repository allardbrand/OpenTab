...
public class Microflows
{
	...
	public static String dSO_GetTabName(IContext context)
	{
		try
		{
			Map<String, Object> params = new HashMap<String, Object>();
			return (String)Core.execute(context, "TestSuite.DSO_GetTabName", params);
		}
		catch (CoreException e)
		{
			throw new MendixRuntimeException(e);
	...
	public static String dSO_GetTabNameContext(IContext context, testsuite.proxies.Color _color)
	{
		try
		{
			Map<String, Object> params = new HashMap<String, Object>();
			params.put("Color", _color == null ? null : _color.getMendixObject());
			return (String)Core.execute(context, "TestSuite.DSO_GetTabNameContext", params);
		}
		catch (CoreException e)
		{
			throw new MendixRuntimeException(e);
